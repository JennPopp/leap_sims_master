...
namespace {
  void PrintUsage() {
    G4cerr << " Usage: " << G4endl;
    G4cerr << " leap_sims [-m macro ] [-f outFileName] [-t outType] [-v version] [-d dipolState] [-c caloType] [-b beamLine]" << G4endl;
  }
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
...
for ( G4int i=1; i<argc; i=i+2 ) {
  ...
  runManager->SetUserInitialization(det = new DetectorConstruction(version, dipolState, caloType, beamLine));
